        ...
        return [
          'access' => [
              ...
              'rules' => [
                  ...
                  [
                      'actions' => ['index','view','create','update','delete','bulk-delete','logout'],
                      'allow' => true,
                      'roles' => ['@'],
                  ],
              ],
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Ubicacion",
                    'content'=>'<span class="text-success">Create Ubicacion success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
